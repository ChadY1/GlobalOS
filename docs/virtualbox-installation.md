# Installation de Global-OS 2.0.0-alpha sous VirtualBox (2010–2026)
...
5. **Montage de l'ISO**
   - Stockage → Contrôleur IDE/SATA → Ajouter un lecteur optique → Choisir le fichier ISO `Global-K-OS-2.0.0-alpha.iso` (ou le nom généré par `scripts/build.sh`).
